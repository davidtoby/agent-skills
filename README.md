...
A bilingual collection of reusable skills for **OpenClaw**, **Claude**, and other capable coding/agent runtimes. This repo is for skills that survive real work: not toy prompts, but workflows, scripts, references, and battle-tested operating patterns.
...
### 1. video-bilingual-subtitle-delivery
...
如果你手里有一个经得起真实任务的 Skill，欢迎直接提 PR。  
